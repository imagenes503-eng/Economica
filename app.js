...
function guardarProducto(e) {
  ...
  // Broadcast instantáneo del producto actualizado a otros dispositivos
  if (typeof _broadcast === 'function') {
    const savedProdB = productos.find(x => String(x.id) === String(id || '')) || productos[productos.length - 1];
    if (savedProdB) _broadcast('producto', { ...savedProdB, img: null }); // img va por canal separado
  }
