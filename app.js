...
function navTo(pgId, pushHistory = true) {
  ...
  // Las sub-páginas de inventario mantienen dniInventario activo
  ...
  ['dniVenta', 'dniInventario', 'dniReportes', 'dniDestacados', 'dniVentasDiarias', 'dniSync', 'dniAdmin'].forEach((id, i) => {
    ...
    // Las sub-páginas de inventario mantienen dniInventario marcado como activo
  ...
  if (pgId === 'pgInvAnalisis' && typeof renderInvAnalisis === 'function') renderInvAnalisis();
  if (pgId === 'pgInvProductos' && typeof renderInv === 'function') renderInv();
...
function editarProd(id) {
  ...
  // Navegar directamente a la sub-página de registro/edición
