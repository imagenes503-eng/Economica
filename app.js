...
function renderInvTotales() {
  ...
  if (peBox && peGrid) {
    if (hayPE) {
      ...
      // capitalActual = caja actual + inventario actual a costo
      // - cajaActual ya refleja ventas confirmadas - gastos
      // - totalInvCompra es el valor real del stock disponible hoy
      // - puntoEq = efectivoInicial + invCostoBase (inventario inicial a costo, fijo)
      // La diferencia (ganancia/pérdida) refleja lo que creció o bajó el capital vs inicio del mes
