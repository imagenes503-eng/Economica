...
function finalizarVenta() {
  ...
  if (typeof _broadcast === 'function') {
    ...
    // BUGFIX SYNC: también avisar al otro teléfono que consulte la tabla ventas
    // directamente. Si el broadcast 'venta' se pierde, este 'snapshot_push' hace
    // que el otro teléfono llame _autoCargarDesdeSupa() como respaldo inmediato.
    // El receiver de snapshot_push ya existe en supabase_sync.js.
    setTimeout(() => _broadcast('snapshot_push', { tienda: localStorage.getItem('vpos_tiendaId') }), 800);
  }
