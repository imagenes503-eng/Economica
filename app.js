...
function navTo(pgId, pushHistory = true) {
  ...
  const ids    = ['pgDash', 'pgInventario', 'pgReportes', 'pgDestacados', 'pgVentasDiarias', 'pgSync', 'pgAdmin'];
...
window.addEventListener('popstate', (e) => {
  ...
  const validas = ['pgDash','pgInventario','pgReportes','pgDestacados','pgVentasDiarias','pgSync','pgAdmin'];
