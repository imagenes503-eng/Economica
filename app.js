...
function renderCajaPanel() {
  ...
  const capitalTotal       = cajaActual + invCompra;         // 💵 Caja + 📦 Inventario actual
  ...
  balance.innerHTML = `
    <div>
      ...
      <div style="font-size:11px;color:var(--text-muted);font-weight:700;margin-top:3px;">💵 Caja actual + 📦 Inventario actual (precio costo)</div>
    </div>
