...
function renderCajaPanel() {
  ...
  grid.innerHTML = `
    <!-- ── Sección CAJA ──────────────────────────────────────── -->
    <div style="grid-column:1/-1;background:#fff;border:2px solid #86efac;border-radius:14px;overflow:hidden;margin-bottom:2px;">
      <div style="background:linear-gradient(135deg,#065f46,#047857);padding:11px 16px;display:flex;align-items:center;gap:10px;">
        ...
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">CAJA</div>
          <div style="font-size:11px;color:#a7f3d0;font-weight:700;">Dinero físico disponible</div>
        </div>
      </div>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;padding:12px 14px;">
        ${card('🏁','Caja Inicial','$'+efectivoInicial.toFixed(2),'Dinero en caja al iniciar el mes','#0369a1','#f0f9ff','#7dd3fc')}
      ...
      <div style="background:#f0f9ff;border-top:1px solid #bbf7d0;padding:7px 14px;font-size:11px;color:#15803d;font-weight:700;">
        ℹ️ Caja Actual = $${efectivoInicial.toFixed(2)} + $${entroACaja.toFixed(2)} − $${totalEgresos.toFixed(2)} = $${cajaActual.toFixed(2)}
      </div>
    </div>

    <!-- ── Inventario Inicial Fijo (baseline del mes) ────────────── -->
    <div style="grid-column:1/-1;background:#fff;border:2px solid #fcd34d;border-radius:14px;overflow:hidden;margin-bottom:2px;">
      <div style="background:linear-gradient(135deg,#78350f,#92400e);padding:11px 16px;display:flex;align-items:center;gap:10px;">
        ...
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">INVENTARIO INICIAL</div>
          <div style="font-size:11px;color:#fde68a;font-weight:700;">Valor fijo al inicio del mes — no cambia con las ventas</div>
        </div>
      </div>
      ...
      <div style="background:#fffbeb;border-top:1px solid #fde68a;padding:7px 14px;font-size:11px;color:#92400e;font-weight:700;">
        ℹ️ Estos valores se fijan el 1° del mes. Actualízalos en Inventario → Capital e Inventario → 🔄 Recalcular
      </div>
    </div>
    <!-- placeholder para que el innerHTML no rompa el bloque — se omite la fila del builder -->
    ...
    <!-- ── Sección INVENTARIO ────────────────────────────────── -->
    <div style="grid-column:1/-1;background:#fff;border:2px solid #7dd3fc;border-radius:14px;overflow:hidden;margin-bottom:2px;">
      <div style="background:linear-gradient(135deg,#0369a1,#0284c7);padding:11px 16px;display:flex;align-items:center;gap:10px;">
        <div style="width:32px;height:32px;background:rgba(255,255,255,0.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:18px;">📦</div>
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">INVENTARIO</div>
          <div style="font-size:11px;color:#bae6fd;font-weight:700;">Valor de tu inventario actual</div>
        </div>
      </div>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;padding:12px 14px;">
    ...
    <!-- ── Sección RENDIMIENTO DEL MES ──────────────────────── -->
    <div style="grid-column:1/-1;background:#fff;border:2px solid ${esGN?'#86efac':'#fca5a5'};border-radius:14px;overflow:hidden;margin-bottom:2px;">
      <div style="background:linear-gradient(135deg,${esGN?'#064e3b,#065f46':'#7f1d1d,#991b1b'});padding:11px 16px;display:flex;align-items:center;gap:10px;">
        <div style="width:32px;height:32px;background:rgba(255,255,255,0.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:18px;">📊</div>
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">RENDIMIENTO DEL MES</div>
          <div style="font-size:11px;color:${esGN?'#a7f3d0':'#fca5a5'};font-weight:700;">Resumen de ventas y utilidad</div>
        </div>
      </div>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;padding:12px 14px;">
    ...
    <!-- ── Sección CAPITAL TOTAL (solo informativo) ─────────── -->
    <div style="grid-column:1/-1;background:#fff;border:2px solid #e5e7eb;border-radius:14px;overflow:hidden;margin-bottom:2px;">
      <div style="background:linear-gradient(135deg,#1e3a5f,#1d4ed8);padding:11px 16px;display:flex;align-items:center;gap:10px;">
        <div style="width:32px;height:32px;background:rgba(255,255,255,0.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:18px;">🏦</div>
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">CAPITAL TOTAL</div>
          <div style="font-size:11px;color:#bfdbfe;font-weight:700;">Solo informativo — no afecta ningún cálculo</div>
        </div>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:12px 14px;">
        <div style="background:#f0f9ff;border:2px solid #7dd3fc;border-radius:12px;padding:12px 14px;">
    ...
    <div style="grid-column:1/-1;background:#fff;border:2px solid #e5e7eb;border-radius:14px;overflow:hidden;">
      <div style="background:linear-gradient(135deg,#374151,#111827);padding:11px 16px;display:flex;align-items:center;gap:10px;">
        <div style="width:32px;height:32px;background:rgba(255,255,255,0.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:18px;">📉</div>
        <div>
          <div style="font-size:13px;font-weight:900;color:#fff;">ESTADÍSTICAS RÁPIDAS</div>
          <div style="font-size:11px;color:#9ca3af;font-weight:700;">Indicadores clave del mes</div>
        </div>
      </div>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;padding:12px 14px;">
