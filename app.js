...
function renderInvTotales() {
  ...
  if (peBox && peGrid) {
    if (hayPE) {
      ...
      // capitalActual = caja actual + valor del inventario disponible HOY a costo
      // NO se suma invCostoBase fijo porque el inventario vendido ya se convirtió en caja
