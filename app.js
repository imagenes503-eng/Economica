...
try{_guardarProductoSupabase({ id: Date.now(), cod: newCod, nom: newNom, cat: newCat, abrev: newAbrev, compra: newCompra, venta: newVenta, stock: newStock, min: newMin, lotes: [], paquetes: [], img: newImg });}catch(e){console.error(e);}
  }
  cancelarEdicion();
  salvar();
...
try{_eliminarProductoSupabase(id);}catch(e){console.error(e);}
...
try{_guardarProductoSupabase(ep);}catch(e){console.error(e);}
  });
