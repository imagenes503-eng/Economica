...
function renderCajaPanelMini() {
  ...
  // FIX: usar ventasMes (reconstruido desde historial POS) para Caja.
  // Es la fuente confiable: idéntica a VENTA MES en el dashboard.
  // ventasDiarias puede tener filas obsoletas/duplicadas de Supabase.
