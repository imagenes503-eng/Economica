...
<body>
<div class="center bold" style="font-size:17px;letter-spacing:0.5px;border:2px solid #000;padding:5px 2px;margin-bottom:4px;">COMPROBANTE DE DESPACHO</div>
<div class="center bold" style="font-size:13px;margin-bottom:6px;">TICKET DE CONTROL INTERNO</div>
...
<hr class="divider">
<div class="pie" style="font-size:9px;color:#333;margin-top:6px;border:1px dashed #999;padding:5px 3px;line-height:1.5;">
  Este documento no es una Factura Comercial ni un Crédito Fiscal.<br>
  Es un registro de control de entrega de mercadería.
</div>
<br><br><br>
</body>
</html>`;
