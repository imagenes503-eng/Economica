...
async function _aplicarDatos(datos) {
  ...
  // inventarioInicial se recalcula desde productos (arriba) — no usar valor del snapshot
  // ya que después de ventas el valor correcto es SUM(stock×venta) actual, no el histórico.
  {const el=document.getElementById('inpInventarioInicial');if(el&&typeof inventarioInicial!=='undefined')el.value=inventarioInicial>0?inventarioInicial.toFixed(2):'';}
