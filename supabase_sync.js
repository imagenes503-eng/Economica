...
function _fusionarDos(local, ext) {
  ...
  // 2. Reportes: sumar
  local.ventasDia = _mergeRep(local.ventasDia || {}, ext.ventasDia || {});
  local.ventasSem = _mergeRep(local.ventasSem || {}, ext.ventasSem || {});
  local.ventasMes = _mergeRep(local.ventasMes || {}, ext.ventasMes || {});
