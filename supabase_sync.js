...
async function _aplicarDatos(datos) {
  ...
  // FIX BUG 4: Merge ventasDiarias desde el snapshot en lugar de reemplazar.
  // Reemplazar directo causaba que un snapshot antiguo (sin ventas del día)
  // borrara entradas recientes que autoRegistrarVentaDiaria ya había guardado.
...
async function _subirVentasDiarias(){
  ...
  // FIX BUG 3: NO borrar de Supabase cuando el array local está vacío.
  // Antes borraba todo asumiendo 'no hay ventas', pero podría significar
  // 'aún no se registraron' (race condition con autoRegistrarVentaDiaria).
  // Si realmente se quiere limpiar, hay una función explícita para eso.
