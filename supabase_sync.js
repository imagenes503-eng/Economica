    ...
    if (prods && prods.length > 0) {
      ...
      const merged = sbProds.map(sp => {
        ...
        if (local) {
          ...
          // BUGFIX: usar >= (no >) para que Supabase gane cuando tiene IGUAL cantidad
          // de paquetes pero con datos actualizados (costoPresEntrado, etc.).
          // Antes: sbPkLen > localPkLen → perdía si mismo número de paquetes editados.
          // Ahora: sbPkLen >= localPkLen → Supabase gana si es más reciente, igual o más paquetes.
