...
let _snapTimestamp       = null; // timestamp del último snapshot que subimos
...
// ── Polling: cada 10s revisa si hay snapshots nuevos de otros dispositivos ──
function _iniciarPolling() {
  if (_pollingTimer) return;
  // Primer check inmediato
  setTimeout(_autoFusionar, 2000);
  _pollingTimer = setInterval(_autoFusionar, 10000);
  console.log('[AutoSync] Polling iniciado — sincronización cada 10s');
}
