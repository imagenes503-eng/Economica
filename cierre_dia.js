        ...
        <div class="cd-resumen-captura" id="cdResumenCaptura">
          <div class="cd-cap-inner">
            ...
            <div class="cd-cap-col" id="capAyerWrap" style="margin-bottom:12px;">
              <div class="cd-cap-section-title">📅 Con esto empecé hoy <span id="capAyerFechaTitle"></span></div>
              <div id="capAyerFechaRow" class="cd-cap-row"><span id="capAyerFechaLbl">—</span><span></span></div>
