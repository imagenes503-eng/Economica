...
async function renderCierreDia(pgId){
  ...
  const cambioGrid=_CD_DENOMS.map(d=>`
    <div class="cd-cambio-item">
      ...
      <div class="cd-field" style="margin-bottom:6px;"><label>Monto ($)</label><input class="cd-inp" type="number" id="cdCambioSale${d.id}" min="0" step="0.01" placeholder="0.00" oninput="_cdActualizarStats()" onblur="if(_cdCalcularCambiosPendientes().length)_cdAplicarCambios()"></div>
  ...
  pg.innerHTML=`
    ...
    <div class="cd-body">
      ...
      <div class="cd-panel">
        ...
        <div class="cd-panel-body">
          <div style="font-size:11px;color:#92400e;font-weight:700;background:#fffbeb;border:1px solid #fde68a;border-radius:8px;padding:8px 12px;margin-bottom:12px;font-family:Nunito,sans-serif;">
            💡 Ingresa el efectivo que quedó en caja ayer y presiona "Aplicar a Saldo" para sumarlo al saldo actual.
          </div>
      ...
      <div class="cd-panel">
        <div class="cd-panel-header">
          ...
          <button class="cd-btn-update green" onclick="_cdCalcular('saldo')">🧮 Calcular</button>
        </div>
        <div class="cd-panel-body">
      ...
      <div class="cd-panel">
        ...
        <div class="cd-panel-body">
          <div style="font-size:11px;color:var(--text-muted);font-weight:700;margin-bottom:12px;">Solo redistribuyen denominaciones — se aplican automáticamente al cambiar los montos.</div>
...
async function _cdTomarCaptura(){
  ...
  try{
    ...
    // Escalar para que todo el contenido quepa en 1920px de altura
