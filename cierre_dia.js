...
if(etapa==='venta'){
  ...
  _cdActualizarStats();
  _cdGuardarSaldoCajaExplicit(); // persist final computed saldo
  _cdCerrarModal();
}
...
function _cdAplicarCambios(){
  ...
  _cdActualizarStats();
  _cdGuardarSaldoCajaExplicit(); // persist after cambios
}
...
async function _cdTomarCaptura(){
  ...
  try{
    ...
    // Draw thin uniform blue border frame on all 4 sides
    const BORDER = 18; // px at 2× scale = 9px visual at 1×
