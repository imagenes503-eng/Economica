      ...
      <div class="cd-panel">
        ...
        <div class="cd-panel-body">
          <div class="cd-field" style="margin-bottom:12px;">
            ...
            <input class="cd-inp big" type="number" id="cdVentaTotal" min="0" step="0.01" placeholder="0.00" value="${vSug>0?vSug.toFixed(2):''}" oninput="_cdActualizarStats()" onblur="if(_cdV('cdVentaTotal')>0)_cdAplicarVentaASaldo()">
