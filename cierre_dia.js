...
(function _estilosCierre() {
  ...
  s.textContent = `
    ...
    .cd-panel.active .cd-panel-body{display:block;}
...
async function renderCierreDia(pgId){
    ...
    <div class="cd-body">
      ...
      <div class="cd-panel">
        <div class="cd-panel-header">
          ...
          <button class="cd-btn-update" onclick="_cdGuardarAyer()">💾 Guardar saldo actual</button>
        </div>
        <div class="cd-panel-body">
  ...
  setTimeout(()=>{
    document.querySelectorAll('.cd-panel').forEach((panel,i)=>{
...
function _cdCalcular(etapa){
  ...
  // CAMBIOS DEL DÍA:
  // Solo mover dinero entre denominaciones sin recalcular venta/gastos
  if(etapa==='cambios'){
    const movs=_cdCalcularCambiosPendientes();
...
window.addEventListener('beforeunload',()=>{
  try{ _cdGuardarEstadoAutomatico(); }catch(e){}
});
