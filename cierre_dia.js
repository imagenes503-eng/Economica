...
(function _estilosCierre() {
  ...
  s.textContent = `
    ...
    .cd-resumen-captura{background:#fff;border:1.5px solid #cbd5e1;border-radius:14px;font-family:var(--cd-ff);width:100%;box-sizing:border-box;overflow:hidden;}
    ...
    /* ── PRINT MODE: 1080px exacto, todo escalado para llenar 9:16 ── */
    .cd-print-mode .cd-resumen-captura{width:1080px!important;border:none!important;margin:0!important;border-radius:0!important;background:#ffffff!important;}
    .cd-print-mode .cd-cap-inner{padding:44px 44px 36px!important;}
    .cd-print-mode .cd-cap-title-emoji{font-size:60px!important;margin-bottom:8px!important;}
    .cd-print-mode .cd-cap-title{font-size:52px!important;}
    .cd-print-mode .cd-cap-fecha{font-size:24px!important;margin-top:8px!important;}
    .cd-print-mode .cd-cap-header-wrap{margin-bottom:32px!important;}
    .cd-print-mode .cd-cap-2col{gap:20px!important;margin-bottom:20px!important;grid-template-columns:1fr 1fr!important;}
    .cd-print-mode .cd-cap-col{padding:16px 18px!important;border-width:2px!important;border-radius:14px!important;}
    .cd-print-mode .cd-cap-section-title{font-size:16px!important;padding:8px 14px!important;margin:-16px -18px 14px!important;}
    .cd-print-mode .cd-cap-row{font-size:20px!important;padding:9px 0!important;}
    .cd-print-mode .cd-cap-row.total{font-size:23px!important;padding-top:10px!important;margin-top:6px!important;}
    .cd-print-mode .cd-cap-row.grand{font-size:24px!important;padding:14px 18px!important;margin-top:10px!important;}
    .cd-print-mode .cd-cap-saldo-full{border-radius:14px!important;margin-bottom:20px!important;}
    .cd-print-mode .cd-cap-saldo-header{font-size:18px!important;padding:12px 18px!important;}
    .cd-print-mode .cd-cap-saldo-body{padding:14px 18px!important;}
    .cd-print-mode .cd-cap-alq-row{padding:14px 18px!important;margin-top:14px!important;border-radius:12px!important;}
    .cd-print-mode .cd-cap-alq-row span:first-child{font-size:21px!important;}
    .cd-print-mode .cd-cap-alq-row span:last-child{font-size:26px!important;}
    .cd-print-mode .cd-cap-gastos-row{padding:7px 0!important;}
    .cd-print-mode .cd-cap-gastos-desc,.cd-print-mode .cd-cap-gastos-total{font-size:18px!important;}
    .cd-print-mode .cd-cap-gastos-denoms{font-size:14px!important;}
    /* Util colors */
...
function _cdRestaurarEstadoAutomatico(){
  try{
    // Saldo/Ayer ya restaurados inmediatamente antes de este setTimeout
    setTimeout(()=>{
      // Re-aplicar saldo/ayer por seguridad (por si _cdAutoRecalcSaldo los pisó)
      ...
      // Estado general (gastos, venta, cambios) — se borra con borrar datos
