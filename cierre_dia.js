...
function _cdCalcular(etapa){
  // Paso 1: Saldo = Venta por denominación + Ayer por denominación
  _CD_DENOMS.forEach(d=>{
    const v=_cdV('cdVenta'+d.id);
  ...
  if(etapa==='venta'){
    ...
    if(typeof toast==='function')toast(`✓ Saldo calculado: Venta + Ayer = $${t.toFixed(2)}`);
    _cdActualizarStats();
    return;
  }
