...
async function renderCierreDia(pgId){
  ...
  const efectivoVendidoNeto = ingresoRealMes - totalGastosMes;
  const valorInventarioActual = (typeof productos !== 'undefined' ? productos : [])
    .reduce((s, p) => s + (Number(p.stock) || 0) * (Number(p.venta) || 0), 0);
  const patrimonioTotal = saldoEfec + efectivoVendidoNeto + valorInventarioActual;
        ...
        <div class="cd-panel-body">
          ...
          <div style="background:#ecfeff;border:1.5px solid #a5f3fc;border-radius:12px;padding:14px 16px;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;padding-bottom:8px;border-bottom:1px dashed #a5f3fc;">
              ...
              <span style="font-size:13px;font-weight:900;color:#0e7490;">$${saldoEfec.toFixed(2)}</span>
            </div>
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;padding-bottom:8px;border-bottom:1px dashed #a5f3fc;">
              <span style="font-size:11.5px;font-weight:800;color:#0e7490;">📤 Gastos/pagos este mes</span>
              <span style="font-size:13px;font-weight:900;color:#dc2626;">-$${totalGastosMes.toFixed(2)}</span>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;padding-bottom:8px;border-bottom:1px dashed #a5f3fc;">
