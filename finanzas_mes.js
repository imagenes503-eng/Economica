...
function _apRecibidosKey() {
  return 'vpos_rec_' + new Date().toISOString().split('T')[0];
}
...
function _apRefreshAll() {
  _apRefreshForm(); _apRefreshTabla(); _apRefreshPedidos(); _apRefreshStats(); _apRefreshHoy();
}
...
function renderFinanzasMes(pgId) {
  ...
  pg.innerHTML =
    ...
    '<div class="ap-panel-hdr"><div class="ap-panel-ico ico-verde">🏭</div><div class="ap-panel-txt"><div class="ap-panel-title">Registrar / Editar Proveedor</div><div class="ap-panel-desc">Nombre · días de pedido · días de entrega</div></div></div>' +
    '<div class="ap-panel-body"><div id="apFormWrap"></div></div></div>' +
    // Tabla
    '<div class="ap-panel">' +
    '<div class="ap-panel-hdr"><div class="ap-panel-ico ico-azul">📋</div><div class="ap-panel-txt"><div class="ap-panel-title">Proveedores Registrados</div><div class="ap-panel-desc">Pedido y entrega · Lunes a Domingo</div></div><span class="ap-badge" id="apBadge">'+total+'</span></div>' +
    '<div id="apTablaWrap"></div></div>' +
    // Pedidos de hoy
